...
advertise-address=148.100.98.235 \
...
etcd-certfile=/srv/kubernetes/etcd.crt \
etcd-keyfile=/srv/kubernetes/etcd.key \
etcd-servers=https://148.100.98.235:2379 \
...
master=https://148.100.98.235:6443 \
v=2
....
...
v=2 \
hostname-override=148.100.98.235 \
port=10250 \
logtostderr \
