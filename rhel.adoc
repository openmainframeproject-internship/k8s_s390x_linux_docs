...
After you ssh into your instance check the rhel version using the below command and wait for some time. Now do rerun the same command the rhel version gets updated.
